/* ###################### ANSWERS TO 30 JAVASCRIPT EXERCISES #################### */

//NUMBER ONE
let myName = "Tanko Emmanuel";
...
console.log("The Calculated Area Of The Rectangle Is: " + areaOfRectangle);
...
console.log(reverseString("MODULUS"));
...
console.log(countingVowels("I Love JavaScript"));

//NUMBER NINE
let arrayOfNumbers = [23, 33, 72, 40, 55];
let largestNumber = Math.max(...arrayOfNumbers);
...
console.log(isWordPalindrome("racecar"));
console.log(isWordPalindrome("Modulus"));
